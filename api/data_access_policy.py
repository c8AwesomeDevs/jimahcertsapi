...
class PIDataAccessPolicy(AccessPolicy):
    ...
    statements = [
        {
            "action": ["get_user_groups","extract_data","view_data","save_edited_data","upload_certificate_data","test_pi_connection","view_pdf","preview_configuration_api","extract_manual_log_template"],
